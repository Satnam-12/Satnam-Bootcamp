...
export default function Home() {
  ...
  const importToken = async () => {
    ...
    const tokenImage =
      "https://static.hiphopdx.com/2023/12/drake-introduces-his-newest-alter-ego-complete-with-its-own-accesory-1200x675.jpg";
  ...
  return (
    <main
      style={{
        ...
        backgroundImage:
          'url("https://i.wpimg.pl/1200x788/filerepo.grupawp.pl/api/v1/display/embed/5a754f28-670a-4666-a5f4-93dc4bca1d1f")',
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", border: "2px solid #000000", padding: "10px", marginBottom: "20px" }}>
        <form>
          <label style={{ fontSize: "18px", color: "#000000" }}>
            Input the amount you would like to stake right here and watch your investment grow! 
          </label>
          <br />
        </form>
        <input
